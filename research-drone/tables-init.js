...
const Tables = (function(Helpers){
    ...
    const statsCols = [
        ...
        { title: "LVL" },
        { title: "Drone Recharge Time", dataKey: "drone_recharge_seconds@value" },//3
        { title: "Chance of Drone collecting Shards", dataKey: "drone_premium_modifier@modifier!percent2" },
        { title: "Collection Mission Success Chance", dataKey: "drone_collect_failure_modifier@modifier!percent2" },//5
        { title: "Salvage Mission Success Chance", dataKey: "drone_salvage_failure_modifier@modifier!percent2" },
        { title: "Rescue Mission Success Chance", dataKey: "drone_rescue_failure_modifier@modifier!percent2" },
        { title: "Chance of Second Drone Reward", dataKey: "drone_bonus_reward1_modifier@modifier!percent2" },
        { title: "Chance of Third Drone Reward", dataKey: "drone_bonus_reward2_modifier@modifier!percent2" },
        { title: "Troop Research", dataKey: "unlocked@modifier" }, //10
    ];
