...
const Tables = (function(Helpers){
    const costsCols = [
        ...
        { title:"Neut Boost 1D 9", dataKey: "boost_currency7_1d@value" },//45
    ...
    const costsColumnMap = {
        ...
        supplyshop_core_alien_component_1_b: [29,30,5,6,8],
        supplyshop_core_alien_component_2_a: [31,32,13,16,23],
        supplyshop_core_alien_component_2_b: [33,34,14,16,24],
        supplyshop_core_alien_armor_1_a: [35,36,37,38,39],
        supplyshop_core_alien_armor_1_b: [40,41,16,7,27],
        supplyshop_core_alien_armor_2_a: [42,43,16,44,23],
        supplyshop_core_alien_armor_2_b: [4,15,26,42,30],
        supplyshop_core_data_disk_1_a: [4,5,6,7,8],
        supplyshop_core_data_disk_1_b: [29,32,45,16,18],
        supplyshop_core_data_disk_2_a: [14,15,16,17,23],
        supplyshop_core_data_disk_2_b: [46,47,37,36,22],
        supplyshop_core_classified_documents_1_a: [24,25,26,27,28],
        supplyshop_core_classified_documents_1_b: [16,42,6,8,37],
        supplyshop_core_classified_documents_2_a: [31,13,16,32,23],
        supplyshop_core_classified_documents_2_b: [17,43,15,7,8],
        supplyshop_armory_blueprints_1_a: [35,36,37,38,39],
        supplyshop_armory_blueprints_1_b: [32,26,8,23,18],
        supplyshop_armory_blueprints_2_a: [42,43,16,44,23],
        supplyshop_armory_blueprints_2_b: [22,21,5,30,48],
