...
const Tables = (function(Helpers){
    ...
    const statsCols = [
        { title: "Key", visible: false },
        { title: "LVL" },
        { title: "Detail Available", dataKey: "scout level" },
        ...
        { title: 'Advanced Engines <span class="info-icon" data-tip="Ground, Air Speed">❓</span>', dataKey: "vehicle_speed_modifier@modifier" },
    ...
    const statsColumnMap = {
        ...
        defensivefortifieddefenses:[13],
        defensiveturretattack:[13],
